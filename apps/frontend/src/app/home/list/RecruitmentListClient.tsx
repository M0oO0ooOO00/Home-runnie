...
import type { GetRecruitmentPostsResponse, RecruitmentPostItemResponse } from '@/apis/post/post';
              ...
              posts.map((item, index) => {
                ...
                return (
                  <Link
                    key={item.id}
                    href={`/home/${item.id}`}
                    className="block bg-neutral-50 border-t border-zinc-200 px-5 lg:px-10 py-4 lg:py-5 first:border-t-0 cursor-pointer hover:bg-gray-50 transition-colors"
                  >
